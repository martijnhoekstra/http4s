...
object Uri {
  ...
  object Ipv6Address {
    ...
    private[http4s] val parser: P[Ipv6Address] = {
      ...
      def repExactly[A](n: Int, p: cats.parse.Parser0[A], sep: cats.parse.Parser0[Unit] = P.unit): cats.parse.Parser0[List[A]] =
